                        ...
                        <div className="6u 12u(medium)">
                                ...
                                <div className="box alt">
                                    <div className="row 50% uniform">
                                        <div className="4u"><span className="image fit"><img src="/client/static/images/pic08.jpg" alt="" /></span></div>
                                        <div className="4u"><span className="image fit"><img src="/client/static/images/pic09.jpg" alt="" /></span></div>
                                        <div className="4u"><span className="image fit"><img src="/client/static/images/pic10.jpg" alt="" /></span></div>
                                        <div className="4u"><span className="image fit"><img src="/client/static/images/pic10.jpg" alt="" /></span></div>
                                        <div className="4u"><span className="image fit"><img src="/client/static/images/pic08.jpg" alt="" /></span></div>
                                        <div className="4u"><span className="image fit"><img src="/client/static/images/pic09.jpg" alt="" /></span></div>
                                        <div className="4u"><span className="image fit"><img src="/client/static/images/pic09.jpg" alt="" /></span></div>
                                ...
                                <h4>Left &amp; Right</h4>
                                <p><span className="image left"><img src="/client/static/images/pic09.jpg" alt="" /></span>Lorem ipsum dolor sit accumsan interdum nisi, quis tincidunt felis sagittis eget. tempus euismod. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan eu faucibus. Integer ac pellentesque praesent tincidunt felis sagittis eget. tempus euismod. Vestibulum ante ipsum primis sagittis eget. tempus euismod. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan eu faucibus. Integer ac pellentesque praesent tincidunt felis sagittis eget tempus vestibulum ante ipsum primis in faucibus magna blandit adipiscing eu felis iaculis.</p>
                                <p><span className="image right"><img src="/client/static/images/pic10.jpg" alt="" /></span>Lorem ipsum dolor sit accumsan interdum nisi, quis tincidunt felis sagittis eget. tempus euismod. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan eu faucibus. Integer ac pellentesque praesent tincidunt felis sagittis eget. tempus euismod. Vestibulum ante ipsum primis sagittis eget. tempus euismod. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan eu faucibus. Integer ac pellentesque praesent tincidunt felis sagittis eget tempus vestibulum ante ipsum primis in faucibus magna blandit adipiscing eu felis iaculis.</p>
